<x-guest-layout>
    ...
    <div class="glass-card rounded-3xl p-8 animate-fade-in-up-delay-2">
        ...
        <!-- Google Login -->
        <a href="{{ route('google.redirect') }}" class="flex items-center justify-center gap-3 w-full py-3 rounded-xl border border-white/20 bg-white/10 hover:bg-white/20 text-white font-semibold text-sm transition-colors">
        ...
        <!-- Register link removed - registration is disabled -->
    </div>
</x-guest-layout>
