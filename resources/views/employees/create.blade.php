...
<div class="space-y-6 relative">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Tambah Karyawan</h1>
            <p class="text-xs sm:text-sm text-gray-500 mt-1">Input data karyawan baru</p>
        </div>
    </div>
    ...
    <div class="relative rounded-2xl p-6"
        ...
        <div class="relative z-10">
            <form action="{{ route('employees.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    <h3 class="text-sm font-bold text-gray-700 uppercase tracking-wider mb-4">Informasi BANK (untuk transfer gaji)</h3>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                ...
                <div>
                    ...
                    <textarea name="notes" rows="3"
                        class="w-full rounded-xl border-gray-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 px-4 py-2.5 text-sm transition-all">{{ old('notes') }}</textarea>
                </div>
