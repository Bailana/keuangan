...
@section('page-title', 'Tambah Jenis Terapi')
...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-xl font-bold text-gray-900">Tambah Jenis Terapi</h1>
    </div>

    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5 sm:p-8">
        <form action="{{ route('therapy-types.store') }}" method="POST" class="space-y-5">
            @csrf
